...
class AdamNavigator {
    ...
    _getMenuConfig() {
        ...
        return [
            ...
            { name: 'Market Mayhem', icon: 'fa-newspaper', link: 'market_mayhem_dashboard.html' },
            { type: 'divider' },
            ...
            { name: 'Conviction Monitor', icon: 'fa-crosshairs', link: 'high_conviction_monitor.html' },
            { name: 'System 2 Critique', icon: 'fa-microscope', link: 'system2_critique_bifurcation.html' },
            { name: 'Agent Log', icon: 'fa-clipboard-list', link: 'agent_alignment_log_feb_2026.html' },
