...
* **US 10-Year Treasury Yield:** 3.11%
* **S&P 500 Index:** 5198
* **High Yield Credit Spread:** 1533 bps
* **Cost of Debt Proxy:** 18.44%
...
* **Risk Officer:** "Floating-base Merton heuristics show a non-linear shift in the implied CRE default probability from 58.74% to 99.9%. This 70.1% an expansion in risk density is directly driven by the concurrent shift of the cost of debt proxy to 18.44% and the contraction in equity asset buffers."
