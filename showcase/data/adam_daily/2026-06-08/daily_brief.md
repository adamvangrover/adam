...
* **US 10-Year Treasury Yield:** 4.51%
* **S&P 500 Index:** 7047
* **High Yield Credit Spread:** 575 bps
* **Cost of Debt Proxy:** 10.26%

## Risk Radar
* **Credit/Refinancing:** Structural default models indicate an implied commercial real estate default probability of 3.5%.
...
* **Risk Officer:** "Floating-base Merton heuristics show a non-linear shift in the implied CRE default probability from 2.69% to 3.5%. This 30.1% an expansion in risk density is directly driven by the concurrent shift of the cost of debt proxy to 10.26% and the contraction in equity asset buffers."
