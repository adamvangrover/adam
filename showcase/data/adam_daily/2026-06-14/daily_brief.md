...
* **US 10-Year Treasury Yield:** 3.78%
* **S&P 500 Index:** 5441
* **High Yield Credit Spread:** 980 bps
* **Cost of Debt Proxy:** 13.58%

## Risk Radar
* **Credit/Refinancing:** Structural default models indicate an implied commercial real estate default probability of 17.5%.
...
* **Risk Officer:** "Floating-base Merton heuristics show a non-linear shift in the implied CRE default probability from 12.07% to 17.5%. This 45.0% an expansion in risk density is directly driven by the concurrent shift of the cost of debt proxy to 13.58% and the contraction in equity asset buffers."
