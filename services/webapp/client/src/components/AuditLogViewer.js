    ...
    return (
        <div style={containerStyle}>
            <h2 style={headerStyle}>
                ...
                <span style={{fontSize: '0.7rem', animation: 'pulse 2s infinite'}}>● LIVE</span>
            </h2>

            <div style={logContainerStyle}>
                {traces.map((trace, idx) => (
                    <div key={trace.trace_id || idx} style={entryStyle}>
                            ...
                            {trace.events.map((event, eIdx) => {
                                ...
                                return (
                                    <div key={eIdx} style={eventStyle}>
                                        ...
                                        <div style={{paddingLeft: '8px', borderLeft: '1px solid #003300', fontSize: '0.8rem', opacity: 0.8, whiteSpace: 'pre-wrap'}}>
                                             ...
                                             {event.payload.analysis && (
                                                 <div style={{marginTop: '4px', fontStyle: 'italic'}}>"{event.payload.analysis.substring(0, 100)}..."</div>
                                             )}
            ...
            <div style={{marginTop: '1rem', fontSize: '0.7rem', color: '#004400', textAlign: 'center', borderTop: '1px solid #002200', paddingTop: '0.5rem'}}>
