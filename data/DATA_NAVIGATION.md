...
| `conviction_list.jsonl` | `ticker` | string | The stock ticker of the company. | | `"NVDA"` |
| `conviction_list.jsonl` | `conviction_score` | integer | A score representing the analyst's conviction level. | | `245` |
| `conviction_list.jsonl` | `outlook` | string | The investment outlook (e.g., Buy, Sell). | | `"Strong Buy"` |
