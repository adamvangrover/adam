...
## `sovereign_ai_analyst_agent`

*   **File:** `core/agents/specialized/sovereign_ai_analyst_agent.py`
*   **Description:** Focuses on the "Sovereign AI" paradigm, analyzing the intersection of national security, AI infrastructure (Capex), and geopolitical fragmentation (GPR Index).
*   **Configuration:** `config/agents.yaml`
    *   `expertise`: ["Sovereign AI", "Geopolitics", "Chip Demand", "Energy Security"]
*   **Architecture and Base Agent:** Inherits from `core.agents.agent_base.AgentBase`.
*   **Agent Forge and Lifecycle:** On demand for strategic reports.
*   **Model Context Protocol (MCP):** Exposes `_analyze_sovereign_ai_landscape`.
*   **Tools and Hooks:** None currently.
*   **Compute and Resource Requirements:** Low.
*   **Dependencies:** None.
