...
class TestV21Config(unittest.TestCase):
    ...
    def test_load_v21_configuration(self):
        ...
        try:
            ...
            self.assertIn("agent_directory", config["agent_network"],
                          "The 'agent_directory' key should be in 'agent_network'.")
            ...
            self.assertIn("adam_v21_master_workflow", workflow_names,
                          "The 'adam_v21_master_workflow' should be defined.")

            # Verify that the new ethical framework is present
            self.assertIn("ethical_and_governance_framework", config,
                          "The 'ethical_and_governance_framework' key should be in the config.")
