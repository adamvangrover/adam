...
if "torch._dynamo" not in sys.modules:
    ...
    # Make disable() a pass-through decorator, accepting any args/kwargs
    mock_dynamo.disable = MagicMock(side_effect=lambda fn=None, *args, **kwargs: (lambda x: x) if fn is None else fn)
