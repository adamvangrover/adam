...
def run():
    with sync_playwright() as p:
        ...
        cwd = os.getcwd()
        url = f"file://{cwd}/showcase/archive_v2/index.html"
        ...
        page.screenshot(path="verification/archive_v2.png", full_page=True)
        print("Screenshot saved to verification/archive_v2.png")
        ...
        try:
            ...
            if buttons:
                ...
                page.screenshot(path="verification/report_v2.png", full_page=True)
                print("Screenshot saved to verification/report_v2.png")
            else:
