...
from src.backend_logic import execute_logic

proj_df, enterprise_value, wacc, risk_model, base_rating, snc_status = execute_logic(
    ebitda_input, growth_input, debt_input, interest_input, entry_mult, equity_pct, kd_input
)
