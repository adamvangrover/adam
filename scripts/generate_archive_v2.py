...
# --- Configuration ---
OUTPUT_DIR = "showcase/archive_v2"
ARCHIVE_FILE = "showcase/archive_v2/index.html"
...
<body>
    <div style="max-width: 1400px; margin: 0 auto; padding: 20px;">
        <a href="index.html" class="cyber-btn">&larr; BACK TO ARCHIVE</a>
    </div>
...
<body>
    ...
    <header class="cyber-header">
        ...
        <nav><a href="../../mission_control_v2.html" style="color:white; text-decoration:none; border:1px solid #555; padding:5px 10px;" class="mono">&larr; MISSION CONTROL</a></nav>
    </header>
