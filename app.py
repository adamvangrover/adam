...
proj_df, enterprise_value, wacc, risk_model, base_rating, snc_status = run_valuation(ebitda_input, growth_input, debt_input, interest_input, entry_mult, equity_pct, kd_input, MOCK_MODE)
