...
if MOCK_MODE:
    proj_df, enterprise_value, wacc, risk_model, base_rating, snc_status = run_mock_logic()
else:
    try:
        # 1. Valuation
        ...
        st.warning("Live Execution Layer connection failed. Falling back to Mock Mode.")
        proj_df, enterprise_value, wacc, risk_model, base_rating, snc_status = run_mock_logic()
