...
#### 🏛️ 🏹 The-Fortress-and-The-Hunt: Mandate-Driven Allocation
...
```json
{
  ...
  "context": {
    ...
    "instructions": [
      ...
      "The newsletter MUST include all new sections: 'Global Pulse' (using geopolitics brief), 'Innovation & Tech' (using ai_tech brief), 'The-Fortress-and-The-Hunt,' 'Market Snapshot,' and 'The Water Cooler' (using fun_fact brief).",
...
```json
{
  ...
  "context": {
    ...
    "instructions": [
      ...
      "Generate a 'Market Mayhem' newsletter for a Family Office, including a new section for 'The-Fortress-and-The-Hunt.'",
