...
class NUMAScheduler:
    ...
    def pin_thread(self, thread_name: str, core_id: int) -> bool:
        """
        ...
        logger.debug(f"Pinning thread {thread_name} to CPU core {core_id}.")
        self._thread_map[thread_name] = core_id
        # Simulated underlying OS system call (e.g., sched_setaffinity)
        return True
